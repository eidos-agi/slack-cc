---
id: TASK-37
title: Identify registrar and host for greenmarkwaste.com
status: To Do
assignee: []
...
Determine who the domain registrar and web host are for greenmarkwaste.com (NTX entity website). Need to know:
...
**Output**: Document findings in the infra repo (e.g., infra/dns/greenmarkwaste.com.md or similar).
<!-- SECTION:DESCRIPTION:END -->

## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 Domain registrar identified for greenmarkwaste.com
